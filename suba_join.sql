...
--Make second table for all of the SUBA predictions
CREATE TABLE 'spreadsheet_suba_all_predictions' AS
SELECT * FROM tair_blast_filt_ids t LEFT JOIN Suba_all_allpredictions s ON t.field2=s.locus;
